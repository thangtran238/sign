                        ...
                        <li data-transition="boxfade" data-slotamount="20" class="active-revslide"
                            ...
                            <div class="slotholder" style="width:100%;height:100%;" data-duration="undefined"
                                ...
                                <div class="tp-bgimg defaultimg" data-lazyload="undefined" data-bgfit="cover"
                                    ...
                                    background-image: url('image/slide/{{$sl->image}}'); background-size: cover; background-position: center center; width: 100%; height: 100%; opacity: 1; visibility: inherit;">
                                </div>
                            </div>
                        </li>
                        @endforeach
                            ...
                            <div class="col-sm-3">
                                <div class="single-item">
                                    ...
                                    <div class="single-item-header">
                                        <a href="detail/{{$new->id}}"><img src="image/product/{{$new->image}}"
                                                alt=""></a>
                                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <div class="single-item">
                                    ...
                                    @endif
                                    <div class="single-item-header">
                                        <a href="product.html"><img src="image/product/{{$spkm->image}}"
                                                alt=""></a>
                                    </div>
                                    <div class="single-item-body">
